...
# Had Gemini add [DEBUG] to all major steps and functions. Used to fix a report name issue. 
# --- Config Options ---
...
if __name__ == "__main__":
    ...
    if not api_key:
        ...
        sys.exit(1)
    print("[DEBUG] GEMINI_API_KEY retrieved successfully.")
    ...
    if scan_success:
        ...
        try:
            ...
            if not report_content:
                ...
                sys.exit(1)
            print("[DEBUG] Nmap report file read successfully.")
        ...
        if report_content:
            ...
            if analysis_result:
                print("[DEBUG] Gemini analysis completed successfully.")
    ...
    print(f"[DEBUG] Script finished. Total duration: {script_duration:.2f} seconds.")
